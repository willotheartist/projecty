    ...
    <>
      ...
      <div style={{ fontFamily: "var(--font-sans), 'DM Sans', sans-serif", color: C.black, background: C.bg }}>
        ...
        <section style={{ padding: "80px clamp(24px,5vw,80px) 100px", background: C.bg }}>
          <div className="hero-split" style={{ maxWidth: 1280, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center" }}>
            <div>
              <FadeUp delay={100}>
              ...
              <FadeUp delay={250}>
                <p style={{ fontSize: 17, color: C.gray2, maxWidth: 480, lineHeight: 1.7, marginBottom: 44 }}>
                  <strong>Waaza</strong> analyses key financial and asset indicators to provide
                  a structured readiness score, indicative financing range, and
                  recommended structuring path.
                </p>
              </FadeUp>
              <FadeUp delay={400}>
                <a href="#contact" className="pill-yellow" style={{
                  display: "inline-flex", alignItems: "center", gap: 8,
                  padding: "18px 36px", background: C.accent, color: C.black,
          ...
          <div className="grid-3" style={{ maxWidth: 1280, margin: "0 auto", display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 48 }}>
            {[
              ...
              <FadeUp key={i} delay={i * 120}>
                ...
                <h3 style={{ fontFamily: "var(--font-serif), 'Instrument Serif', serif", fontSize: "clamp(28px,3.5vw,40px)", fontWeight: 400, lineHeight: 1.1, marginBottom: 16, letterSpacing: -0.5 }}>{v.title}</h3>
                ...
                <div>
                  <FadeUp delay={100}>
                    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20 }}>
                      <div style={{ width: 36, height: 36, borderRadius: 10, background: C.accentPale, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 18, color: C.black }}>◎</div>
                  ...
                  <FadeUp delay={400}>
                    <a href="#contact" className="pill-black" style={{ display: "inline-block", padding: "12px 28px", background: C.black, color: "#fff", fontSize: 14, fontWeight: 600, borderRadius: 10, transition: "background .2s" }}>Learn more</a>
                  </FadeUp>
                </div>
                <FadeUp delay={250}>
        ...
        <section id="platform" style={{ padding: "0 clamp(24px,5vw,80px) 120px" }}>
          <div style={{ maxWidth: 1280, margin: "0 auto" }}>
            ...
            <FadeUp delay={100}>
              <h2 className="section-h2" style={{ fontFamily: "var(--font-serif), 'Instrument Serif', serif", fontSize: "clamp(36px,5vw,64px)", fontWeight: 400, lineHeight: 1.05, letterSpacing: -1.5, maxWidth: 700, marginBottom: 56 }}>
            ...
            <div className="bento-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
              {[
                { title: "Readiness Scoring", desc: "0–100 index combining liquidity strength, asset quality, structuring complexity, income stability, and jurisdiction sensitivity.", bg: C.white, span: false },
                { title: "Institutional Reports", desc: "PDF and web reports with executive summary, LTV projections, structuring recommendation, risk flags, and next steps.", bg: C.white, span: false },
                { title: "Versioned Rule Engine", desc: "Every rule stored, versioned, and auditable. Adjust weights, thresholds, and conditions without rebuilding. Transparent by design.", bg: C.accentPale, span: true },
                { title: "Broker Dashboard", desc: "Financing intelligence embedded in the broker's existing workflow — triggered from the buyer profile, before offer negotiation.", bg: C.white, span: false },
                { title: "API & Embeddable Widget", desc: "REST endpoints and a lightweight drop-in module. Any broker website can surface a readiness score preview.", bg: C.white, span: false },
              ].map((f,i)=>(
                <FadeUp key={i} delay={i * 80} style={f.span ? { gridColumn: "span 2" } : {}}>
                  <div className={`bento ${f.span?"bento-span2":""}`} style={{ background: f.bg, borderRadius: 20, padding: "36px 32px", transition: "transform .2s", height: "100%" }}>
        ...
        <FadeUp style={{ padding: "100px clamp(24px,5vw,80px)" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto", textAlign: "center" }}>
            <h2 style={{ fontFamily: "var(--font-serif), 'Instrument Serif', serif", fontSize: "clamp(28px,4vw,48px)", fontWeight: 400, fontStyle: "italic", lineHeight: 1.2, letterSpacing: -0.5, maxWidth: 900, margin: "0 auto 32px" }}>
        ...
        <section style={{ padding: "0 clamp(24px,5vw,80px) 100px" }}>
          <FadeUp>
            <div style={{ maxWidth: 1280, margin: "0 auto", background: C.white, borderRadius: 28, padding: "clamp(40px,5vw,80px)" }}>
              <div className="split" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "center" }}>
                <FadeUp delay={150}>
          ...
          <div style={{ maxWidth: 1280, margin: "0 auto" }}>
            ...
            <div className="grid-3" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 20 }}>
              {[
                ...
                <FadeUp key={i} delay={i * 120}>
                  <div className="feature-card" style={{ background: C.white, borderRadius: 20, padding: "36px 28px", transition: "all .25s", height: "100%" }}>
                    <h3 style={{ fontFamily: "var(--font-serif), 'Instrument Serif', serif", fontSize: 28, fontWeight: 400, marginBottom: 12, letterSpacing: -0.3 }}>{w.title}</h3>
          ...
          <FadeUp delay={200}>
            <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" as const, maxWidth: 540, margin: "0 auto" }}>
              <input type="email" placeholder="Work Email*" value={email} onChange={(e) => setEmail(e.target.value)} style={{
                ...
                border: `1px solid ${C.gray5}`, borderRadius: 10,
                fontFamily: "var(--font-sans), 'DM Sans', sans-serif", background: C.bg,
              }} />
              <button className="pill-yellow" style={{
                padding: "14px 32px", background: C.accent, color: C.black,
