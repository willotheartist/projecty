...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: "en_GB",
    type: "article",
    images: [{ url: "https://www.waaza.co/og/third-party-boat-insurance-og.jpg", width: 1200, height: 630, alt: "Third party boat insurance guide — Waaza" }],
  },
  twitter: { card: "summary_large_image", site: "@waaza", title: pageData.meta.title, description: pageData.meta.description, images: ["https://www.waaza.co/og/third-party-boat-insurance-og.jpg"] },
