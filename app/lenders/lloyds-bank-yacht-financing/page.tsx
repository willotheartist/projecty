...
export const metadata: Metadata = {
  ...
  openGraph: { title: pageData.meta.title, description: pageData.meta.description, url: pageData.meta.canonical, siteName: "Waaza", locale: "en_GB", type: "article", images: [{ url: "https://www.waaza.co/og/lloyds-bank-yacht-financing-og.jpg", width: 1200, height: 630, alt: "Lloyds Bank yacht financing — Waaza" }] },
  twitter: { card: "summary_large_image", site: "@waaza", title: pageData.meta.title, description: pageData.meta.description, images: ["https://www.waaza.co/og/lloyds-bank-yacht-financing-og.jpg"] },
