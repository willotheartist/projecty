...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: "en_GB",
    type: "article",
    images: [{ url: "https://www.waaza.co/og/vat-on-yacht-purchases-in-europe-og.jpg", width: 1200, height: 630, alt: "VAT on yacht purchases in Europe — Waaza" }],
  },
  twitter: { card: "summary_large_image", site: "@waaza", title: pageData.meta.title, description: pageData.meta.description, images: ["https://www.waaza.co/og/vat-on-yacht-purchases-in-europe-og.jpg"] },
